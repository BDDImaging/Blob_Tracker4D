package trackerType;
import Jama.Matrix;
public class CVMKalmanFilter2D {
	 ...
	 */
	public CVMKalmanFilter2D( final double[] X0, final double initStateCovariance, final double positionProcessStd, final double velocityProcessStd, final double positionMeasurementStd )
	{
		// Initial state
		X = new Matrix( X0, 4 );

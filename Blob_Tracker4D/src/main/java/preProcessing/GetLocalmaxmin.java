...
public class GetLocalmaxmin {
	...
	public static ValuePair<FloatType, FloatType> computesecondMinMaxIntensity(final RandomAccessibleInterval<FloatType> inputimg) {
		...
		ValuePair<FloatType, FloatType> pair = new ValuePair<FloatType, FloatType>(secondmin, max);
		return pair;
	}
	...
	public static long[] computeMaxinLabel(
       ...
       ValuePair<FloatType, FloatType> pair = GetLocalmaxmin.computeMinMaxIntensity(inputimg);
		
		// Neglect bright beads
		
		final Float threshold = (pair.b.get() - pair.a.get())/4;
	...
	public static ValuePair<FloatType, FloatType> computeMinMaxIntensity(final RandomAccessibleInterval<FloatType> inputimg) {
		// create a cursor for the image (the order does not matter)
		final Cursor<FloatType> cursor = Views.iterable(inputimg).cursor();
		...
		ValuePair<FloatType, FloatType> pair = new ValuePair<FloatType, FloatType>(min, max);
		return pair;
	}
